...
if __name__ == "__main__":
    ...
    outup_density_path_list = (
        os.path.join(
            db_path,
            complex_name,
            f"{complex_name}_nconfs{n_confs}_genmode{generation_mode}_res{density_resolution}_nbox{n_box}_threshcorr{threshold_correlation}_delprob{delete_prob}_low_resolution_forward_model.mrc",
        )
